...
from rtc_mediaserver.webrtc_server.constants import AUDIO_SETTINGS, SENTENCES_QUEUE, SYNTHESIZE_IN_PROGRESS
...
async def synthesize(
    ...
    try:
        ...
        request_body = create_request_body_http(tts_text=text, model_id=settings.elevenlabs_model_id)
