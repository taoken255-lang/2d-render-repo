...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_root", type=str, default="/app/weights/checkpoints/ditto_trt_Ampere_Plus", help="path to trt data_root")
    parser.add_argument("--cfg_pkl", type=str, default="/app/weights/checkpoints/ditto_cfg/v0.4_hubert_cfg_trt.pkl", help="path to cfg_pkl")
